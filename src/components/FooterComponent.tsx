...
const FooterComponent = () => {
  ...
  return (
    <footer className="bg-[#1C6AE4]">
      <div className="container mx-auto py-10">
        <div className="flex flex-col gap-y-6 md:flex-row items-center justify-between border-t border-neutral-200 mt-6 pt-2">
          <div className="text-xs text-neutral-100 md:mt-2">
            &copy; Copyright {year}
          </div>
          <div className="flex items-center gap-5">
            <Link
              href="/terms-conditions"
              className="text-xs text-neutral-100 hover:underline"
            >
              Terms & Conditions
            </Link>
